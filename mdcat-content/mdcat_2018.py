...
#
# 2026-09-13: re-transcribed from a 260-dpi crop of the official key image
# (Paper-C column) and checked against the DB, which had already been hand-
# corrected; the previous transcription here disagreed on 59 questions.
# Q188 reads "B" in the key image (the earlier "S" was a misread).
# Q145 is stored as "a" because its option list above is in content order,
# not print order (print-order key letter is D).
KEY_RAW = """
1 d
2 d
3 c
