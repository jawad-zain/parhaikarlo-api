...
from chemistry_practice import QUESTIONS  # noqa: E402
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-chemistry-practice-q{q['id']}",
            "paper_year": None,
            ...
            "explanation": None,
            "needs_review": False,
            "source_file": "chemistry_practice.py",
            "topic": q["topic"],
            "subtopic": q["subtopic"],
            "tag_confidence": "high",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_CHEMISTRY_PRACTICE.json"
