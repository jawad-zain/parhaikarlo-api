"""One-off: create MockTest 'MDCAT Mock 4' and attach the freshly-imported
MDCAT_MOCK_4.json questions to it.
"""
import json
import os
import sys
...
data = json.loads((ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_4.json").read_text(encoding="utf-8"))
