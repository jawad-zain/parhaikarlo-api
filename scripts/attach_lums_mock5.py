"""One-off: create the LCAT Mock 5 MockTest row and attach its 120 questions.

Same pattern as scripts/attach_lums_mock4.py -- Mock 5 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_5.json"
