"""One-off: mdcat_mock_16.py's answer key was skewed toward 'B'
(94/180) and away from 'D' (7/180). Rebalance each question's option
...
SRC = Path(__file__).parent.parent / "mdcat-content" / "mdcat_mock_16.py"
