...
from mdcat_mock_10 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock10-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 10",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_10.json"
