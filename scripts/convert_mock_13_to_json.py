...
from mdcat_mock13 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock13-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 13",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_13.json"
