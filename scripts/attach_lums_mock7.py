"""One-off: create the LCAT Mock 7 MockTest row and attach its 120 questions.

Same pattern as scripts/attach_lums_mock6.py -- Mock 7 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_7.json"
