"""One-off: create the LCAT Mock 3 MockTest row and attach its 120 questions.

Same pattern as scripts/attach_lums_mock2.py -- Mock 3 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_3.json"
