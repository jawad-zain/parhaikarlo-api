...
data = json.loads((ROOT / "mdcat-content" / "mock9_data.json").read_text(encoding="utf-8"))
...
def main():
    ...
    for q in data:
        out.append({
            "id": f"mdcat-mock9-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 9",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_9.json"
