"""One-off: create MockTest 'MDCAT Mock 7' and attach the freshly-imported
MDCAT_MOCK_7.json questions to it.
"""
import json
import os
import sys
...
data = json.loads((ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_7.json").read_text(encoding="utf-8"))
