"""One-off: create MockTest 'MDCAT Mock 11' and attach the freshly-imported
MDCAT_MOCK_11.json questions to it.
"""
import json
import os
import sys
...
data = json.loads((ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_11.json").read_text(encoding="utf-8"))
