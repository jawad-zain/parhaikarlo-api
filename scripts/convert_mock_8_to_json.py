...
from mdcat_mock_8 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock8-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 8",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_8.json"
