"""
Adapter: mdcat_2018.py → parsed-mcqs/2018.json
...
# --- paths ---
SOURCE_FILE = Path("mdcat-content/mdcat_2017.py")
OUTPUT_FILE = Path("mdcat-content/parsed-mcqs/MDCAT_2017.json")
PAPER_YEAR = 2017

# --- load the .py source as a module ---
spec = importlib.util.spec_from_file_location("mdcat_2018", SOURCE_FILE)
