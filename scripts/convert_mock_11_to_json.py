...
from mdcat_mock11 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock11-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 11",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_11.json"
