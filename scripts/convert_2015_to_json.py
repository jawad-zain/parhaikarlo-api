...
# --- paths ---
SOURCE_FILE = Path("mdcat-content/mdcat_2015.py")
OUTPUT_FILE = Path("mdcat-content/parsed-mcqs/MDCAT_2015.json")
PAPER_YEAR = 2015

# --- load the .py source as a module ---
spec = importlib.util.spec_from_file_location("mdcat_2015", SOURCE_FILE)
