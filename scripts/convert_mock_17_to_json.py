...
from mdcat_mock17 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock17-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 17",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_17.json"
