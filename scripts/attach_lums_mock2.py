"""One-off: create the LCAT Mock 2 MockTest row and attach its 120 questions.

Why a quiz.MockTest and not a content.PastPaper: Mock 2 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_2.json"
