...
from mdcat_mock_7 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock7-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 7",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_7.json"
