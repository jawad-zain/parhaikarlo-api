...
data = json.loads((ROOT / "mdcat-content" / "mock5_data.json").read_text(encoding="utf-8"))
...
def main():
    ...
    for q in data:
        out.append({
            "id": f"mdcat-mock5-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 5",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_5.json"
