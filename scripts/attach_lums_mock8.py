"""One-off: create the LCAT Mock 8 MockTest row and attach its 120 questions.

Same pattern as scripts/attach_lums_mock7.py -- Mock 8 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_8.json"
