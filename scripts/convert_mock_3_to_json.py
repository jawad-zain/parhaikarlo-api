...
from mdcat_mock_3 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock3-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 3",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_3.json"
