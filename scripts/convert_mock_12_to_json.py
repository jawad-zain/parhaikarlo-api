...
from mdcat_mock12 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock12-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 12",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_12.json"
