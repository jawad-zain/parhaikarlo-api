...
from mdcat_phy_practice2 import QUESTIONS  # noqa: E402
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-physics-practice2-q{q['id']}",
            "paper_year": None,
            ...
            "explanation": None,
            "needs_review": False,
            "source_file": "mdcat_phy_practice2.py",
            "topic": q["topic"],
            "subtopic": q["topic"],
            "tag_confidence": "high",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_PHYSICS_PRACTICE_2.json"
    ...
    print(f"  visual required: {sum(1 for q in out if q['is_visual_required'])}")
    print("\n  per-topic counts:")
