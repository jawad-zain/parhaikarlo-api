...
from mdcat_mock_14 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock14-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 14",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_14.json"
