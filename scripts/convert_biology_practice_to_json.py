...
from biology_practice import QUESTIONS  # noqa: E402
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-biology-practice-q{q['id']}",
            "paper_year": None,
            ...
            "explanation": None,
            "needs_review": False,
            "source_file": "biology_practice.py",
            "topic": q["topic"],
            "subtopic": q["subtopic"],
            "tag_confidence": "high",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_BIOLOGY_PRACTICE.json"
