"""One-off: attach the freshly-imported MDCAT_MOCK_2.json questions to
MockTest id=2 (was an empty shell before this) and update total_questions.
"""
import json
import os
import sys
...
data = json.loads((ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_2.json").read_text(encoding="utf-8"))

mt = MockTest.objects.get(id=2)
found, missing = [], []
for mcq in data:
