"""One-off: create the LCAT Mock 6 MockTest row and attach its 120 questions.

Same pattern as scripts/attach_lums_mock5.py -- Mock 6 is a full-length mock,
...
JSON_PATH = ROOT / "lums-content" / "parsed-mcqs" / "LUMS_MOCK_6.json"
