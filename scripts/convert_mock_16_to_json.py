...
from mdcat_mock_16 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock15-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 16",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_16.json"
