"""One-off: mdcat_mock11.py's answer key was heavily skewed toward 'B'
(136/180, ~76%) -- an exploitable guessing pattern. Rebalance each
...
Has 5 image-based questions, so the "image" key is preserved on rewrite.
"""
import ast
