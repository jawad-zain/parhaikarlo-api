"""
Adapter: mdcat_2016.py → parsed-mcqs/2016.json
...
# --- paths ---
SOURCE_FILE = Path("mdcat-content/mdcat_2016.py")
OUTPUT_FILE = Path("mdcat-content/parsed-mcqs/MDCAT_2016.json")
PAPER_YEAR = 2016

# --- load the .py source as a module ---
spec = importlib.util.spec_from_file_location("mdcat_2016", SOURCE_FILE)
