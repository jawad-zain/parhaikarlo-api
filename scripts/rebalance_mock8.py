"""One-off: mdcat_mock_8.py's answer key was heavily skewed toward 'B'
(148/180, ~82%) -- an exploitable guessing pattern. Rebalance each
...
Unlike rebalance_mock2.py (no image questions), this file has 5
image-based questions, so the "image" key is preserved on rewrite.
"""
import ast
...
# Replace only the "QUESTIONS = [ ... ]" span in the original source,
# keeping the module docstring and the trailing summarize()/print_answer_key()
# functions untouched.
