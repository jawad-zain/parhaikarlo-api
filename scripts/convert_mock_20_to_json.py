...
from mdcat_mock_20 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock20-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 20",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_20.json"
