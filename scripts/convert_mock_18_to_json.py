...
from mdcat_mock_18 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock18-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 18",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_18.json"
