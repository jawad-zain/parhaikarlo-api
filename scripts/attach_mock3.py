"""One-off: create MockTest id 'MDCAT Mock 3' (didn't exist yet) and attach
the freshly-imported MDCAT_MOCK_3.json questions to it.
"""
import json
import os
import sys
...
data = json.loads((ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_3.json").read_text(encoding="utf-8"))
