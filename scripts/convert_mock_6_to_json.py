...
from mdcat_mock_6 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock6-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 6",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_6.json"
