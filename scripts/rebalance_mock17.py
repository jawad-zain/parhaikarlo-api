"""One-off: mdcat_mock17.py's answer key was skewed toward 'B'
(135/180) and away from 'C'/'D' (12/0). Rebalance each question's option
...
SRC = Path(__file__).parent.parent / "mdcat-content" / "mdcat_mock17.py"
