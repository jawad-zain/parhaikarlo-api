...
from mdcat_mock_19 import QUESTIONS
...
def main():
    ...
    for q in QUESTIONS:
        out.append({
            "id": f"mdcat-mock19-q{q['id']}",
            "paper_year": None,
            "mock_test": "MDCAT Mock Test 19",
    ...
    out_path = ROOT / "mdcat-content" / "parsed-mcqs" / "MDCAT_MOCK_19.json"
